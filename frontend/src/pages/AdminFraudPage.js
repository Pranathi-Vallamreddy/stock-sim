...
const AdminFraudPage = () => {
  ...
  const highRiskCount = users.filter(u => u.risk_score > 80).length;
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="card p-6 border-l-4 border-red-500">
          ...
          <p className="text-xs text-red-500 font-bold mt-2 flex items-center gap-1">
             <AlertTriangle size={12} /> {highRiskCount} high-risk (score &gt; 80)
          </p>
        </div>
        <div className="card p-6 border-l-4 border-amber-500">
          ...
          <p className="text-xs text-amber-500 font-bold mt-2">Accounts flagged above score 30</p>
        </div>
        <div className="card p-6 border-l-4 border-primary">
          ...
          <p className="text-xs text-emerald-500 font-bold mt-2">Held across flagged accounts</p>
        </div>
      </div>
